...
def generate_c5_from_dir(output_dir: str, raw_outlet: str, applicator: str):
    ...
    try:
        ...
        items_out['Category ID'] = df_items.get('Category ID', '')
        items_out['Category'] = df_items.get('Nama kategori', '')
        items_out['Item ID'] = df_items.get('Item ID', '')
        ...
        mods_out['Modifier Group ID'] = df_modifiers.get('Modifier Group ID', '')
        mods_out['Modifier Group'] = df_modifiers.get('Nama modifier group', '')
        mods_out['Modifier ID'] = df_modifiers.get('Modifier ID', '')
