...
PYEOF
    ...
    help|--help|-h)
        ...
        echo -e "    ${DIM}platforms/gofood/outlets/<nama>/  → hasil GoFood (.xlsx)${RESET}"
        echo -e "    ${DIM}platforms/shopee/outlets/<nama>/  → hasil Shopee (.xlsx)${RESET}"
        echo -e "    ${DIM}platforms/grab/outlets/<nama>/    → hasil Grab   (.xlsx)${RESET}"
        echo ""
